...
== Description ==
This plugin allows you to quickly switch between pages, posts, or any other custom post types.
It is aware of its content. For example if you're on a page it will list all the pages.
If you're editing a blog post it will show you other blog posts.
If you're editing a WooCommerce product it will list all of the other products.
